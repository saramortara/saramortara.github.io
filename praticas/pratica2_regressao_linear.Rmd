...
```{r}
# diretorio de trabalho da Sara
## CRIE SEU PROPRIO CAMINHO E LEMBRE-SE DAS DUAS BARRAS // SE ESTÁ NO WINDOWS
...
<center>![](../../teoricas/figuras/lagarta.jpg){width=50%}</center>
...
<center>
![](../../teoricas/figuras/gender_gap.jpg){width=60%}</center>
...
<center>
![](../../teoricas/figuras/sparrow.jpg){width=40%}</center>
